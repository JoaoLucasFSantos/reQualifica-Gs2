...
// Componente Card com alternância de cores (Mantido)
...
const LandingPage = ({ theme, toggleTheme }) => {
  return (
    <div className="min-h-screen">
      ...
      {/* ----------------------------------------------------------------- */}
      {/* 1. SEÇÃO HERO / HEADER - ReQualifica: Transforme Seu Futuro Profissional */}
      {/* ----------------------------------------------------------------- */}
      ...
      {/* ----------------------------------------------------------------- */}
      {/* 2. SEÇÃO: NOSSO PROPÓSITO - Ensino Gratuito de Qualidade */}
      {/* ----------------------------------------------------------------- */}
      <section className="py-20 bg-bg-light-card dark:bg-bg-dark-card">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex justify-center md:justify-start order-2 md:order-1">
            <img 
              src="https://images.educamaisbrasil.com.br/content/noticias/senaisp-oferece-530-vagas-em-curso-gratuito-na-area-de-ti_g.jpg" 
              alt="Pessoa assistindo a um curso online" 
              className="rounded-lg shadow-xl max-w-full h-auto"
            />
          </div>
          {/* Texto à Direita */}
          <div className="order-1 md:order-2">
            <h2 className="text-4xl font-bold mb-4 text-secondary-orange">
      ...
      {/* ----------------------------------------------------------------- */}
      {/* 3. SEÇÃO: CERTIFICAÇÃO PRÓPRIA - Validando seu Conhecimento */}
      {/* ----------------------------------------------------------------- */}
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <h2 className="text-4xl font-bold mb-4 text-primary-red">
              Certificação Validada pelo Mercado
            </h2>
            <p className="text-lg mb-4 text-text-dark-main dark:text-text-dark-main-light">
          ...
          <div className="flex justify-center md:justify-end">
            <img 
              src="https://content.app-us1.com/gQoMa/2025/01/18/006aad44-5ec4-40af-879d-8ec33f266ae4.png" 
              alt="Certificado ReQualifica" 
              className="rounded-lg shadow-xl max-w-full h-auto"
            />
          </div>
        </div>
      ...
      {/* ----------------------------------------------------------------- */}
      {/* 4. SEÇÃO: CONEXÃO MERCADO - Encontre e Seja Encontrado */}
      {/* ----------------------------------------------------------------- */}
      <section className="py-20 bg-bg-light-card dark:bg-bg-dark-card">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          {/* Imagem à Esquerda */}
          <div className="flex justify-center md:justify-start order-2 md:order-1">
            <img 
              src="https://deltabc.com.br/wp-content/uploads/2025/04/como-fazer-uma-reuniAo-online-3.webp" 
              alt="Pessoas fazendo networking ou sendo contratadas online" 
              className="rounded-lg shadow-xl max-w-full h-auto"
            />
          </div>
          {/* Texto à Direita */}
